...
void MenuLayer::init() {
	...
	background = new Background("res/backgrounds/fondo_menu.png", WIDTH * 0.5, HEIGHT * 0.5, game);
	button = new Actor("res/boton_jugar.png", WIDTH * 0.5, HEIGHT * 0.80, 130, 70, game);
}
